...
El sistema SHALL mostrar en `/admin/pedidos/[id]` el detalle completo de un pedido: datos del cliente, dirección de envío, ítems con cantidades, precios y **texto de personalización** (si aplica), total y estado actual.

#### Scenario: Detalle visible con personalización
- **WHEN** el admin navega a el detalle de un pedido que contiene una placa o nomenclatura
- **THEN** el sistema muestra el texto personalizado ("Texto: ...") en la fila del ítem correspondiente
